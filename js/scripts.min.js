...
$(function(){
    $('#menu__nav').mmenu({
        ...
        navbar:{
            title: '<div class="menu__title"><p><span>A</span>lexis</p></div>'
        },
        onClick:{
            close: true, 
            setSelected: false,
    ...
    var apiMmenu = $('#menu__nav').data('mmenu');
    ...
    $('.testimonials__carousel').on('initialized.owl.carousel', function(){
        setTimeout(function(){
            carouselService()
        }, 100);
    });
    ...
    $('#michael').mouseover(function(){
        $('.team__about').removeClass().addClass('team__about');
        $('.team__about').addClass('team__about_michael-info');
        $('#employee-name').text('Michael Shmitt');
        $('#employee-inf').text('Monetization first mover advantage iPad. Interaction design buzz handshake. Stealth agile development branding. Backing facebook hackathon conversion startup scrum project niche market business-to-consumer paradigm shift traction. Rockstar bandwidth twitter ownership success disruptive series A financing user experience buyer client social proof validation hypotheses. User experience crowdfunding facebook seed round A/B testing mass market.');
    });
    $('#david').mouseover(function(){
        $('.team__about').removeClass().addClass('team__about');
        $('.team__about').addClass('team__about_david-info');
        $('#employee-name').text('David Krämer');
        $('#employee-inf').text('Monetization first mover advantage iPad. Rockstar bandwidth twitter ownership success disruptive series A financing user experience buyer client social proof validation hypotheses. User experience crowdfunding facebook seed round A/B testing mass market.');
    });
    $('#anna').mouseover(function(){
        $('.team__about').removeClass().addClass('team__about');
        $('.team__about').addClass('team__about_anna-info');
        $('#employee-name').text('Anna Schröder');
        $('#employee-inf').text('Monetization first mover advantage iPad. Interaction design buzz handshake. Stealth agile development branding. Backing facebook hackathon conversion startup scrum project niche market business-to-consumer paradigm shift traction.');
    });
    $('#jason').mouseover(function(){
        $('.team__about').removeClass().addClass('team__about');
        $('.team__about').addClass('team__about_jason-info');
        $('#employee-name').text('Jason Teichmann');
        $('#employee-inf').text('Interaction design buzz handshake. Stealth agile development branding. Backing facebook hackathon conversion startup scrum project niche market business-to-consumer paradigm shift traction. Rockstar bandwidth twitter ownership success disruptive series A financing user experience buyer client social proof validation hypotheses.');
    });
...
/* function colClassAdder(){
    if($(window).width()<='754'){
        $('#main-price').addClass('col-sm-12');
    }
    else if($(window).width()>'754'){
        $('#main-price').removeClass('col-sm-12');
    }
}colClassAdder();

$(window).resize(colClassAdder); */
